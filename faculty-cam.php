...
$meta = [
    'title' => 'Communication & Media | Faculty Endeavour | CCE',
    'description' => 'The Lord Jesus Christ was a master communicator. Christians must be well equipped to access and control the global communication and media space.',
];
include 'header.php';

// Fetch Faculty Leader
$leaderStmt = $pdo->prepare("SELECT * FROM people WHERE faculty_id = ? LIMIT 1");
$leaderStmt->execute(['cam']);
...
<main class="flex-grow bg-white">
    ...
    <section class="bg-primary text-white border-b-4 border-secondary pt-16 pb-32 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
            <span class="text-[250px] md:text-[400px] font-heading font-bold leading-none tracking-tighter">CAM</span>
        </div>
        <div class="max-w-6xl mx-auto px-4 relative z-10">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="inline-block bg-white text-primary text-xs font-bold uppercase tracking-widest px-3 py-1">CAM</span>
            </div>
                ...
                <div class="lg:w-1/3 space-y-8">
                    ...
                    <div class="bg-primary text-white p-8 border-b-4 border-secondary">
                        ...
                        <p class="text-gray-300 font-light mb-6">
                            Become a member of the CAM faculty and start transforming your sphere of influence today.
                        </p>
