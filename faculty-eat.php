...
$meta = [
    'title' => 'Education & Training | Faculty Endeavour | CCE',
    'description' => 'Professional educationist and technical trainers receive knowledge and skills to formulate and implement an educational system that functions efficiently to drive industry and promote the glory of God.',
];
include 'header.php';

// Fetch Faculty Leader
$leaderStmt = $pdo->prepare("SELECT * FROM people WHERE faculty_id = ? LIMIT 1");
$leaderStmt->execute(['eat']);
...
<main class="flex-grow bg-white">
    ...
    <section class="bg-primary text-white border-b-4 border-secondary pt-16 pb-32 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
            <span class="text-[250px] md:text-[400px] font-heading font-bold leading-none tracking-tighter">EAT</span>
        </div>
        <div class="max-w-6xl mx-auto px-4 relative z-10">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="inline-block bg-white text-primary text-xs font-bold uppercase tracking-widest px-3 py-1">EAT</span>
            </div>
            ...
            <p class="text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl">
                Professional educationist and technical trainers receive knowledge and skills to formulate and implement an educational system that functions efficiently to drive industry and promote the glory of God.
            </p>
        </div>
    </section>
                ...
                <div class="lg:w-2/3 bg-white p-8 md:p-12 shadow-xl border border-gray-100">
                    ...
                    <div class="mb-12">
                        ...
                        <ul class="list-disc pl-6 space-y-4 text-gray-700 text-lg font-light marker:text-secondary">
                            <li>Design and advocate for value-based educational curricula.</li>
                                <li>Enhance the pedagogical skills of Christian educators.</li>
                                <li>Promote excellence and integrity in educational administration.</li>
                                <li>Bridge the gap between academia and industry through functional training.</li>
                ...
                <div class="lg:w-1/3 space-y-8">
                    ...
                    <div class="bg-gray-50 p-8 border border-gray-200 border-t-4 border-t-primary">
                        ...
                        <p class="text-gray-600 font-light leading-relaxed mb-6">
                            Teachers, Lecturers, School Administrators, Curriculum Developers, and Corporate Trainers.
                        </p>
                    ...
                    <div class="bg-primary text-white p-8 border-b-4 border-secondary">
                        ...
                        <p class="text-gray-300 font-light mb-6">
                            Become a member of the EAT faculty and start transforming your sphere of influence today.
                        </p>
