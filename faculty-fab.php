...
$meta = [
    'title' => 'Finance & Business | Faculty Endeavour | CCE',
    'description' => 'Finance and business drive economies because they are the gatekeepers of global resources. Christians must engage this arena with competence and godliness.',
];
include 'header.php';

// Fetch Faculty Leader
$leaderStmt = $pdo->prepare("SELECT * FROM people WHERE faculty_id = ? LIMIT 1");
$leaderStmt->execute(['fab']);
...
<main class="flex-grow bg-white">
    ...
    <section class="bg-primary text-white border-b-4 border-secondary pt-16 pb-32 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
            <span class="text-[250px] md:text-[400px] font-heading font-bold leading-none tracking-tighter">FAB</span>
        </div>
        <div class="max-w-6xl mx-auto px-4 relative z-10">
            <nav class="flex text-sm text-gray-400 font-medium uppercase tracking-widest mb-8">
                ...
                <span class="mx-3 border-l border-gray-500"></span>
                <span class="text-white">FAB</span>
            </nav>
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="inline-block bg-white text-primary text-xs font-bold uppercase tracking-widest px-3 py-1">FAB</span>
            </div>
            ...
            <p class="text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl">
                Finance and business drive economies because they are the gatekeepers of global resources. Christians must engage this arena with competence and godliness.
            </p>
        </div>
    </section>
                ...
                <div class="lg:w-2/3 bg-white p-8 md:p-12 shadow-xl border border-gray-100">
                    ...
                    <div class="mb-12">
                        ...
                        <ul class="list-disc pl-6 space-y-4 text-gray-700 text-lg font-light marker:text-secondary">
                            <li>Instill biblical principles of wealth creation, stewardship, and investment.</li>
                                <li>Equip entrepreneurs to build scalable, sustainable, and ethical businesses.</li>
                                <li>Promote Kingdom-minded economic policies and financial practices.</li>
                                <li>Facilitate networking and resource sharing among Christian business leaders.</li>
                ...
                <div class="lg:w-1/3 space-y-8">
                    ...
                    <div class="bg-gray-50 p-8 border border-gray-200 border-t-4 border-t-primary">
                        ...
                        <p class="text-gray-600 font-light leading-relaxed mb-6">
                            Entrepreneurs, Bankers, Accountants, Investors, and Corporate Executives.
                        </p>
                    ...
                    <div class="bg-primary text-white p-8 border-b-4 border-secondary">
                        ...
                        <p class="text-gray-300 font-light mb-6">
                            Become a member of the FAB faculty and start transforming your sphere of influence today.
                        </p>
