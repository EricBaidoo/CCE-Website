...
$meta = [
    'title' => 'Governance & Development | Faculty Endeavour | CCE',
    'description' => 'Governance practitioners are equipped with seculo-spiritual aptitude so they can produce godly and competent leadership to drive true development locally, nationally and globally.',
];
include 'header.php';

// Fetch Faculty Leader
$leaderStmt = $pdo->prepare("SELECT * FROM people WHERE faculty_id = ? LIMIT 1");
$leaderStmt->execute(['gad']);
...
<main class="flex-grow bg-white">
    ...
    <section class="bg-primary text-white border-b-4 border-secondary pt-16 pb-32 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
            <span class="text-[250px] md:text-[400px] font-heading font-bold leading-none tracking-tighter">GAD</span>
        </div>
        <div class="max-w-6xl mx-auto px-4 relative z-10">
            <nav class="flex text-sm text-gray-400 font-medium uppercase tracking-widest mb-8">
                ...
                <span class="mx-3 border-l border-gray-500"></span>
                <span class="text-white">GAD</span>
            </nav>
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="inline-block bg-white text-primary text-xs font-bold uppercase tracking-widest px-3 py-1">GAD</span>
            </div>
            
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight max-w-4xl">
                Governance & Development
            </h1>
            <p class="text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl">
                Governance practitioners are equipped with seculo-spiritual aptitude so they can produce godly and competent leadership to drive true development locally, nationally and globally.
            </p>
        </div>
    </section>
                ...
                <div class="lg:w-2/3 bg-white p-8 md:p-12 shadow-xl border border-gray-100">
                    <div class="mb-12">
                        ...
                        <p class="text-gray-700 leading-loose text-lg font-light">
                            The Governance & Development (GAD) faculty is dedicated to raising a new generation of leaders who understand that true development is rooted in righteous governance. We believe that when governance is driven by godly principles, the resulting policies and structures will invariably lead to sustainable development, justice, and equity.
                        </p>
                    </div>
                    ...
                    <div class="mb-12">
                        ...
                        <ul class="list-disc pl-6 space-y-4 text-gray-700 text-lg font-light marker:text-secondary">
                            <li>Equip leaders with biblical principles for public administration and policy-making.</li>
                                <li>Develop frameworks for ethical governance and anti-corruption strategies.</li>
                                <li>Train practitioners to implement sustainable development goals with a Christian worldview.</li>
                                <li>Foster a network of Christian politicians, civil servants, and development workers.</li>
                ...
                <div class="lg:w-1/3 space-y-8">
                    ...
                    <div class="bg-gray-50 p-8 border border-gray-200 border-t-4 border-t-primary">
                        ...
                        <p class="text-gray-600 font-light leading-relaxed mb-6">
                            Politicians, Civil Servants, Policy Makers, NGO Leaders, and Development Consultants.
                        </p>
                    ...
                    <div class="bg-primary text-white p-8 border-b-4 border-secondary">
                        ...
                        <p class="text-gray-300 font-light mb-6">
                            Become a member of the GAD faculty and start transforming your sphere of influence today.
                        </p>
